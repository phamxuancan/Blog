 ...
 */
	public function testCreate() {
		$this->Task->args = array('aro', 'root', 'Users.1');
		$this->Task->expects($this->at(0))->method('out')->with("<success>New Aro</success> 'Users.1' created.", 2);
		$this->Task->expects($this->at(1))->method('out')->with("<success>New Aro</success> 'Users.3' created.", 2);
