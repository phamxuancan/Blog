 ...
 */
	public function testRoleInheritance() {
		$roles = $this->Acl->Aro->roles('Users/peter');
		$this->assertEquals(array('Role/accounting'), $roles[0]);
		$this->assertEquals(array('Users/peter'), $roles[1]);
		...
		$this->assertEquals(array('Users/hardy'), $roles[3]);
	}
 ...
 */
	public function testAddRole() {
		...
		$this->Acl->Aro->addRole(array('Users/foobar' => 'Role/accounting'));
		$this->assertEquals(array(array('Role/accounting'), array('Users/foobar')), $this->Acl->Aro->roles('foobar'));
	}
 ...
 */
	public function testAroResolve() {
		$this->Acl->Aro->map = array(
			'Users' => 'FooModel/nickname',
			'Role' => 'FooModel/role',
		);

		$this->assertEquals('Role/default', $this->Acl->Aro->resolve('Foo.bar'));
		$this->assertEquals('Users/hardy', $this->Acl->Aro->resolve('FooModel/hardy'));
		$this->assertEquals('Users/hardy', $this->Acl->Aro->resolve('hardy'));
		$this->assertEquals('Users/hardy', $this->Acl->Aro->resolve(array('FooModel' => array('nickname' => 'hardy'))));
 ...
 */
	public function testAroAliases() {
		...
		$this->Acl->Aro->addRole(array('Users/foo' => 'Role/IT, Role/accounting'));
 ...
 */
	public function testCheck() {
		...
		$this->assertTrue($this->Acl->check(array('Users' => array('username' => 'jan')), '/controllers/bar/bll'));
