 ...
 */
	public function testAuthorizeFalse() {
		...
		$this->Auth->Session->write('Auth.Users', $user['AuthUser']);
 ...
 */
	public function testIsAuthorizedMissingFile() {
		...
		$this->Controller->Auth->isAuthorized(array('Users' => array('id' => 1)));
	}
 ...
 */
	public function testIsAuthorizedDelegation() {
		...
		$this->assertTrue($this->Auth->isAuthorized(array('Users'), $request));
	}
 ...
 */
	public function testIsAuthorizedUsingUserInSession() {
		...
		$this->Auth->Session->write('Auth.Users', $user);
		$mocks = $this->Auth->constructAuthorize();
 ...
 */
	public function testShutDown() {
		$this->Auth->Session->write('Auth.Users', 'not empty');
 ...
 */
	public function testLogout() {
		$this->Auth->Session->write('Auth.Users.id', '1');
 ...
 */
	public function testUser() {
		...
		$result = $this->Auth->user('username');
		$this->assertEquals($data['Users']['username'], $result);

		$result = $this->Auth->user('Group.name');
		$this->assertEquals($data['Users']['Group']['name'], $result);
