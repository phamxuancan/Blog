 ...
 * @var array
 */
	public $belongsTo = array('Users' => array('className' => 'UserForm'));
}
 ...
 */
	public function setUp() {
		...
		ClassRegistry::addObject('Users', new UserForm());
 ...
 */
	public function testFormSecureWithCustomNameAttribute() {
		...
		$this->Form->text('UserForm.published', array('name' => 'data[Users][custom]'));
		$this->assertEquals('Users.custom', $this->Form->fields[0]);

		$this->Form->text('UserForm.published', array('name' => 'data[Users][custom][another][value]'));
		$this->assertEquals('Users.custom.another.value', $this->Form->fields[1]);
	}
 ...
 */
	public function testInputZero() {
		...
		$expected = array(
			...
			'input' => array('type' => 'text', 'name' => 'data[Users][0]', 'id' => 'User0'),
			'/div'
		);
		$this->assertTags($result, $expected);
	}
 ...
 */
	public function testInputCheckbox() {
		$result = $this->Form->input('Users.active', array('label' => false, 'checked' => true));
		$expected = array(
			'div' => array('class' => 'input checkbox'),
			'input' => array('type' => 'hidden', 'name' => 'data[Users][active]', 'value' => '0', 'id' => 'UserActive_'),
			array('input' => array('type' => 'checkbox', 'name' => 'data[Users][active]', 'value' => '1', 'id' => 'UserActive', 'checked' => 'checked')),
			'/div'
		);
		$this->assertTags($result, $expected);

		$result = $this->Form->input('Users.active', array('label' => false, 'checked' => 1));
		$expected = array(
			'div' => array('class' => 'input checkbox'),
			'input' => array('type' => 'hidden', 'name' => 'data[Users][active]', 'value' => '0', 'id' => 'UserActive_'),
			array('input' => array('type' => 'checkbox', 'name' => 'data[Users][active]', 'value' => '1', 'id' => 'UserActive', 'checked' => 'checked')),
		...
		$result = $this->Form->input('Users.disabled', array(
			'label' => 'Disabled',
			'type' => 'checkbox',
			'data-foo' => 'disabled'
		));
		$expected = array(
			'div' => array('class' => 'input checkbox'),
			'input' => array('type' => 'hidden', 'name' => 'data[Users][disabled]', 'value' => '0', 'id' => 'UserDisabled_'),
			array('input' => array(
				'type' => 'checkbox',
				'name' => 'data[Users][disabled]',
				'value' => '1',
				'id' => 'UserDisabled',
				'data-foo' => 'disabled'
			)),
 ...
 */
	public function testInputSelectType() {
		...
		$this->View->viewVars['users'] = array('value' => 'good', 'other' => 'bad');
		$this->Form->request->data = array('Users' => array('Users' => array('value')));
		$result = $this->Form->input('Users.Users', array('empty' => true));
		$expected = array(
			'div' => array('class' => 'input select'),
			'label' => array('for' => 'UserUser'),
			'Users',
			'/label',
			'input' => array('type' => 'hidden', 'name' => 'data[Users][Users]', 'value' => '', 'id' => 'UserUser_'),
			'select' => array('name' => 'data[Users][Users][]', 'id' => 'UserUser', 'multiple' => 'multiple'),
			array('option' => array('value' => '')),
			'/option',
			array('option' => array('value' => 'value', 'selected' => 'selected')),
			'good',
 ...
 */
	public function testInputWithNonStandardPrimaryKeyMakesHidden() {
		...
		$expected = array(
			'input' => array('type' => 'hidden', 'name' => 'data[Users][model_id]', 'id' => 'UserModelId'),
		);
		$this->assertTags($result, $expected);
	}
 ...
 */
	public function testInputOverridingMagicSelectType() {
		...
		$expected = array(
			'div' => array('class' => 'input text'),
			'label' => array('for' => 'ModelUserId'), 'Users', '/label',
 ...
 */
	public function testInputWithMatchingFieldAndModelName() {
		...
		$this->Form->request->data['Users']['Users'] = 'ABC, Inc.';
		$result = $this->Form->input('Users', array('type' => 'text'));
		$expected = array(
			'div' => array('class' => 'input text'),
			'label' => array('for' => 'UserUser'), 'Users', '/label',
			'input' => array('name' => 'data[Users][Users]', 'type' => 'text', 'id' => 'UserUser', 'value' => 'ABC, Inc.'),
			'/div'
		);
		$this->assertTags($result, $expected);
	}
 ...
 */
	public function testYearAutoExpandRange() {
		$this->Form->request->data['Users']['birthday'] = '1930-10-10';
		$result = $this->Form->year('Users.birthday');
 ...
 */
	public function testCreate() {
		...
		$this->Form->request['action'] = 'add';
		$result = $this->Form->create('Users', array('url' => array('action' => 'login')));
		$expected = array(
			'form' => array(
		...
		$result = $this->Form->create('Users', array('action' => 'login'));
		$expected = array(
			'form' => array(
		...
		$result = $this->Form->create('Users', array('url' => '/users/login'));
		$expected = array(
		...
		$result = $this->Form->create('Users', array('action' => 'signup'));
		$expected = array(
			'form' => array(
 ...
 */
	public function testCreateAutoUrl() {
		...
		$this->Form->request->here = '/base_url/contacts/delete/10/Users:42';
		$this->Form->request->base = '/base_url';
		$result = $this->Form->create('Contact');
		$expected = array(
			'form' => array(
				'id' => 'ContactDeleteForm', 'method' => 'post', 'action' => '/base_url/contacts/delete/10/Users:42',
				'accept-charset' => 'utf-8'
			),
			'div' => array('style' => 'display:none;'),
			'input' => array('type' => 'hidden', 'name' => '_method', 'value' => 'POST'),
 ...
 */
	public function testCreateWithInputDefaults() {
		...
		$expected = array(
			'input' => array('type' => 'text', 'name' => 'data[Users][username]', 'id' => 'UserUsername')
		);
		$this->assertTags($result, $expected);
 ...
 */
	public function testHtml5Inputs() {
		$result = $this->Form->email('Users.email');
		$expected = array(
			'input' => array('type' => 'email', 'name' => 'data[Users][email]', 'id' => 'UserEmail')
		);
		$this->assertTags($result, $expected);

		$result = $this->Form->search('Users.query');
		$expected = array(
			'input' => array('type' => 'search', 'name' => 'data[Users][query]', 'id' => 'UserQuery')
		);
		$this->assertTags($result, $expected);

		$result = $this->Form->search('Users.query', array('value' => 'test'));
		$expected = array(
			'input' => array('type' => 'search', 'name' => 'data[Users][query]', 'id' => 'UserQuery', 'value' => 'test')
		);
		$this->assertTags($result, $expected);

		$result = $this->Form->search('Users.query', array('type' => 'text', 'value' => 'test'));
		$expected = array(
			'input' => array('type' => 'text', 'name' => 'data[Users][query]', 'id' => 'UserQuery', 'value' => 'test')
		);
		$this->assertTags($result, $expected);

		$result = $this->Form->input('Users.website', array('type' => 'url', 'value' => 'http://domain.tld', 'div' => false, 'label' => false));
		$expected = array(
			'input' => array('type' => 'url', 'name' => 'data[Users][website]', 'id' => 'UserWebsite', 'value' => 'http://domain.tld')
		);
		$this->assertTags($result, $expected);
	}
