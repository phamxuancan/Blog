	...
	public function testKeyCheck() {
		...
		$data = array(
			array(
				...
				'Users' => array('id' => '1', 'user' => 'mariano', 'password' => '5f4dcc3b5aa765d61d8327deb882cf99', 'created' => '2007-03-17 01:16:23', 'updated' => '2007-03-17 01:18:31'),
				'Comment' => array(
 ...
 */
	public function testExtract() {
		$a = array(
			...
			array(
				'Article' => array('id' => '3', 'user_id' => '1', 'title' => 'Third Article', 'body' => 'Third Article Body', 'published' => 'Y', 'created' => '2007-03-18 10:43:23', 'updated' => '2007-03-18 10:45:31'),
				'Users' => array('id' => '2', 'user' => 'mariano', 'password' => '5f4dcc3b5aa765d61d8327deb882cf99', 'created' => '2007-03-17 01:16:23', 'updated' => '2007-03-17 01:18:31'),
				'Comment' => array(),
				'Tag' => array()
			),
			array(
				'Article' => array('id' => '3', 'user_id' => '1', 'title' => 'Third Article', 'body' => 'Third Article Body', 'published' => 'Y', 'created' => '2007-03-18 10:43:23', 'updated' => '2007-03-18 10:45:31'),
				'Users' => array('id' => '3', 'user' => 'mariano', 'password' => '5f4dcc3b5aa765d61d8327deb882cf99', 'created' => '2007-03-17 01:16:23', 'updated' => '2007-03-17 01:18:31'),
				'Comment' => array(),
				'Tag' => array()
			),
			array(
				'Article' => array('id' => '3', 'user_id' => '1', 'title' => 'Third Article', 'body' => 'Third Article Body', 'published' => 'Y', 'created' => '2007-03-18 10:43:23', 'updated' => '2007-03-18 10:45:31'),
				'Users' => array('id' => '4', 'user' => 'mariano', 'password' => '5f4dcc3b5aa765d61d8327deb882cf99', 'created' => '2007-03-17 01:16:23', 'updated' => '2007-03-17 01:18:31'),
				'Comment' => array(),
				'Tag' => array()
			),
			array(
				'Article' => array('id' => '3', 'user_id' => '1', 'title' => 'Third Article', 'body' => 'Third Article Body', 'published' => 'Y', 'created' => '2007-03-18 10:43:23', 'updated' => '2007-03-18 10:45:31'),
				'Users' => array('id' => '5', 'user' => 'mariano', 'password' => '5f4dcc3b5aa765d61d8327deb882cf99', 'created' => '2007-03-17 01:16:23', 'updated' => '2007-03-17 01:18:31'),
				'Comment' => array(),
				'Tag' => array()
			)
		);
		...
		$this->assertEquals($expected, Set::extract('/Users/id', $a));
		...
		$r = Set::extract('/Users/id', $a, array('flatten' => false));
		$this->assertEquals($expected, $r);
		...
		$expected = array(2);
		$r = Set::extract('/Users[2]/id', $a);
		$this->assertEquals($expected, $r);

		$expected = array(4, 5);
		$r = Set::extract('/Users[id>3]/id', $a);
		$this->assertEquals($expected, $r);

		$expected = array(2, 3);
		$r = Set::extract('/Users[id>1][id<=3]/id', $a);
		$this->assertEquals($expected, $r);
		...
		$r = Set::extract('/Users/id', $tricky);
		$this->assertEquals($expected, $r);

		$expected = array(4);
		$r = Set::extract('/Users/id', $single);
		$this->assertEquals($expected, $r);

		$expected = array(1, 3);
		$r = Set::extract('/Users[name=/n/]/id', $tricky);
		$this->assertEquals($expected, $r);
		...
		$r = Set::extract('/Comment/Users[name=/bob|dan/]/..', $habtm);
		$this->assertEquals('bob', $r[0]['Comment']['Users']['name']);
		$this->assertEquals('dan', $r[1]['Comment']['Users']['name']);
		$this->assertEquals(2, count($r));

		$r = Set::extract('/Comment/Users[name=/bob|tod/]/..', $habtm);
		$this->assertEquals('bob', $r[0]['Comment']['Users']['name']);

		$this->assertEquals('tod', $r[1]['Comment']['Users']['name']);
		$this->assertEquals(2, count($r));
		...
		$r = Set::extract('/Comment/Users[name=/\w+/]/..', $habtm);
		$this->assertEquals('bob', $r[0]['Comment']['Users']['name']);
		$this->assertEquals('tod', $r[1]['Comment']['Users']['name']);
		$this->assertEquals('dan', $r[2]['Comment']['Users']['name']);
		$this->assertEquals('dan', $r[3]['Comment']['Users']['name']);
		$this->assertEquals(4, count($r));

		$r = Set::extract('/Comment/Users[name=/[a-z]+/]/..', $habtm);
		$this->assertEquals('bob', $r[0]['Comment']['Users']['name']);
		$this->assertEquals('tod', $r[1]['Comment']['Users']['name']);
		$this->assertEquals('dan', $r[2]['Comment']['Users']['name']);
		$this->assertEquals('dan', $r[3]['Comment']['Users']['name']);
		...
		$r = Set::extract('/Users/name', $mixedKeys);
		$this->assertEquals($expected, $r);
 ...
 */
	public function testExtractWithNonZeroArrays() {
		...
		$r = Set::extract('/Users/id', $nonZero);
		$this->assertEquals($expected, $r);

		$expected = array(
			array('Users' => array('id' => 1, 'name' => 'John')),
			array('Users' => array('id' => 2, 'name' => 'Bob')),
			array('Users' => array('id' => 3, 'name' => 'Tony')),
		);
		$result = Set::extract('/Users', $nonZero);
		$this->assertEquals($expected, $result);
		...
		$expected = array(1, 2, 3, 4, 5);
		$this->assertEquals($expected, Set::extract('/Users/id', $nonSequential));

		$result = Set::extract('/Users/id', $nonZero);
 ...
 */
	public function testMatches() {
		...
		$this->assertEquals(array('user'), Set::extract('/Article/keep/Users/fields', $r));
	}
	...
	public function testClassicExtract() {
		...
		$a = array(
			array(
				...
				'Users' => array('id' => 1, 'username' => 'mariano.iglesias'))
			),
			array(
			...
			array(
				...
				'Users' => array('id' => 2, 'username' => 'phpnut'))
			)
		);

		$result = Set::extract($a, '{n}.Article.Users.username');
 ...
 */
	public function testCombine() {
		$result = Set::combine(array(), '{n}.Users.id', '{n}.Users.Data');
		$this->assertTrue(empty($result));
		$result = Set::combine('', '{n}.Users.id', '{n}.Users.Data');
		$this->assertTrue(empty($result));

		$a = array(
			array('Users' => array('id' => 2, 'group_id' => 1,
				'Data' => array('user' => 'mariano.iglesias', 'name' => 'Mariano Iglesias'))),
			array('Users' => array('id' => 14, 'group_id' => 2,
				'Data' => array('user' => 'phpnut', 'name' => 'Larry E. Masters'))),
			array('Users' => array('id' => 25, 'group_id' => 1,
				'Data' => array('user' => 'gwoo', 'name' => 'The Gwoo'))));
		$result = Set::combine($a, '{n}.Users.id');
		$expected = array(2 => null, 14 => null, 25 => null);
		$this->assertEquals($expected, $result);

		$result = Set::combine($a, '{n}.Users.id', '{n}.Users.non-existant');
		$expected = array(2 => null, 14 => null, 25 => null);
		$this->assertEquals($expected, $result);

		$result = Set::combine($a, '{n}.Users.id', '{n}.Users.Data');
		$expected = array(
		...
		$result = Set::combine($a, '{n}.Users.id', '{n}.Users.Data.name');
		$expected = array(
			2 => 'Mariano Iglesias',
			14 => 'Larry E. Masters',
			25 => 'The Gwoo');
		...
		$result = Set::combine($a, '{n}.Users.id', '{n}.Users.Data', '{n}.Users.group_id');
		$expected = array(
			1 => array(
				2 => array('user' => 'mariano.iglesias', 'name' => 'Mariano Iglesias'),
				25 => array('user' => 'gwoo', 'name' => 'The Gwoo')),
		...
		$result = Set::combine($a, '{n}.Users.id', '{n}.Users.Data.name', '{n}.Users.group_id');
		$expected = array(
			1 => array(
				2 => 'Mariano Iglesias',
				25 => 'The Gwoo'),
		...
		$result = Set::combine($a, '{n}.Users.id', array('{0}: {1}', '{n}.Users.Data.user', '{n}.Users.Data.name'), '{n}.Users.group_id');
		$expected = array(
			1 => array(
		...
		$result = Set::combine($a, array('{0}: {1}', '{n}.Users.Data.user', '{n}.Users.Data.name'), '{n}.Users.id');
		$expected = array('mariano.iglesias: Mariano Iglesias' => 2, 'phpnut: Larry E. Masters' => 14, 'gwoo: The Gwoo' => 25);
		$this->assertEquals($expected, $result);

		$result = Set::combine($a, array('{1}: {0}', '{n}.Users.Data.user', '{n}.Users.Data.name'), '{n}.Users.id');
		$expected = array('Mariano Iglesias: mariano.iglesias' => 2, 'Larry E. Masters: phpnut' => 14, 'The Gwoo: gwoo' => 25);
		$this->assertEquals($expected, $result);

		$result = Set::combine($a, array('%1$s: %2$d', '{n}.Users.Data.user', '{n}.Users.id'), '{n}.Users.Data.name');
		$expected = array('mariano.iglesias: 2' => 'Mariano Iglesias', 'phpnut: 14' => 'Larry E. Masters', 'gwoo: 25' => 'The Gwoo');
		$this->assertEquals($expected, $result);

		$result = Set::combine($a, array('%2$d: %1$s', '{n}.Users.Data.user', '{n}.Users.id'), '{n}.Users.Data.name');
		...
		$b->users = array(
			...
			array('Users' => array('id' => 25, 'group_id' => 1,
				'Data' => array('user' => 'gwoo', 'name' => 'The Gwoo'))));
		$result = Set::combine($b, 'users.{n}.Users.id');
		$expected = array(2 => null, 14 => null, 25 => null);
		$this->assertEquals($expected, $result);

		$result = Set::combine($b, 'users.{n}.Users.id', 'users.{n}.Users.non-existant');
		$expected = array(2 => null, 14 => null, 25 => null);
		$this->assertEquals($expected, $result);
 ...
 */
	public function testMapReverse() {
		...
		$expected = array('Users' => array('psword' => 'whatever', 'Icon' => array('id' => 851)));
		$map = Set::map($expected);
		$result = Set::reverse($map);
		$this->assertEquals($expected, $result);
		...
		$expected = array('Users' => array('psword' => 'whatever', 'Icon' => array('id' => 851), 'Profile' => array('name' => 'Some Name', 'address' => 'Some Address')));
		$class = new stdClass;
		$class->User = new stdClass;
		$class->User->psword = 'whatever';
		$class->User->Icon = new stdClass;
		...
		$expected = array('Users' => array('psword' => 'whatever',
						'Icon' => array('id' => 851),
		...
		$result = Set::reverse($class);
		$expected = array('Users' => array('id' => '100'), 'Profile' => array('name' => 'Joe Mamma'));
		$this->assertEquals($expected, $result);
	}
