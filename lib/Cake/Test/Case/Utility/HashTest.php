 ...
 */
	public function testContains() {
		...
		$a = array(
			array('Users' => array('id' => 1)),
			array('Users' => array('id' => 2)),
		);
		$b = array(
			array('Users' => array('id' => 1)),
			array('Users' => array('id' => 2)),
			array('Users' => array('id' => 3))
		);
		$this->assertTrue(Hash::contains($b, $a));
		$this->assertFalse(Hash::contains($a, $b));
	}
 ...
 */
	public function testExtractNumericMixedKeys() {
		...
		$result = Hash::extract($data, 'Users.{n}.name');
 ...
 */
	public function testExtractNumericNonZero() {
		...
		$result = Hash::extract($data, '{n}.Users.name');
 ...
 */
	public function testCombine() {
		$result = Hash::combine(array(), '{n}.Users.id', '{n}.Users.Data');
		$this->assertTrue(empty($result));

		$a = self::userData();

		$result = Hash::combine($a, '{n}.Users.id');
		$expected = array(2 => null, 14 => null, 25 => null);
		$this->assertEquals($expected, $result);

		$result = Hash::combine($a, '{n}.Users.id', '{n}.Users.non-existant');
		$expected = array(2 => null, 14 => null, 25 => null);
		$this->assertEquals($expected, $result);

		$result = Hash::combine($a, '{n}.Users.id', '{n}.Users.Data');
		$expected = array(
		...
		$result = Hash::combine($a, '{n}.Users.id', '{n}.Users.Data.name');
		$expected = array(
			2 => 'Mariano Iglesias',
			14 => 'Larry E. Masters',
			25 => 'The Gwoo');
 ...
 */
	public function testCombineWithGroupPath() {
		...
		$result = Hash::combine($a, '{n}.Users.id', '{n}.Users.Data', '{n}.Users.group_id');
		$expected = array(
			1 => array(
				2 => array('user' => 'mariano.iglesias', 'name' => 'Mariano Iglesias'),
				25 => array('user' => 'gwoo', 'name' => 'The Gwoo')
		...
		$result = Hash::combine($a, '{n}.Users.id', '{n}.Users.Data.name', '{n}.Users.group_id');
		$expected = array(
			1 => array(
				2 => 'Mariano Iglesias',
				25 => 'The Gwoo'
 ...
 */
	public function testCombineWithFormatting() {
		...
		$result = Hash::combine(
			$a,
			'{n}.Users.id',
			array('%1$s: %2$s', '{n}.Users.Data.user', '{n}.Users.Data.name'),
			'{n}.Users.group_id'
		);
		$expected = array(
			1 => array(
		...
		$result = Hash::combine(
			$a,
			array('%1$s: %2$d', '{n}.Users.Data.user', '{n}.Users.id'),
			'{n}.Users.Data.name'
		);
		$expected = array(
		...
		$result = Hash::combine(
			$a,
			array('%2$d: %1$s', '{n}.Users.Data.user', '{n}.Users.id'),
			'{n}.Users.Data.name'
		);
		$expected = array(
			'2: mariano.iglesias' => 'Mariano Iglesias',
 ...
 */
	public function testFormat() {
		...
		$result = Hash::format(
			$data,
			array('{n}.Users.Data.user', '{n}.Users.id'),
			'%s, %s'
		);
		$expected = array(
			'mariano.iglesias, 2',
