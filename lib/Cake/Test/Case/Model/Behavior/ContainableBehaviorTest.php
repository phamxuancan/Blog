 ...
 */
	public function setUp() {
		parent::setUp();
		$this->User = ClassRegistry::init('Users');
 ...
 */
	public function testContainments() {
		...
		$this->assertTrue(Set::matches('/Users', $r));
		$this->assertTrue(Set::matches('/Comment', $r));
		$this->assertTrue(Set::matches('/Article/keep/Comment/conditions/Comment[user_id=2]', $r));

		$r = $this->_containments($this->Article, array('Comment(comment, published)' => 'Attachment(attachment)', 'Users(user)'));
		$this->assertTrue(Set::matches('/Comment', $r));
		$this->assertTrue(Set::matches('/Users', $r));
		$this->assertTrue(Set::matches('/Article/keep/Comment', $r));
		$this->assertTrue(Set::matches('/Article/keep/Users', $r));
		$this->assertEquals(array('comment', 'published'), Hash::extract($r, 'Article.keep.Comment.fields'));
		$this->assertEquals(array('user'), Hash::extract($r, 'Article.keep.Users.fields'));
		...
		$r = $this->_containments($this->Article, array('Comment.Users'));
		$this->assertEquals(array('Users', 'Comment', 'Article'), array_keys($r));

		$result = Hash::extract($r, 'Users[keep]');
		$this->assertEquals(array('keep' => array()), array_shift($result));

		$result = Hash::extract($r, 'Comment[keep]');
		$this->assertEquals(array('keep' => array('Users' => array())), array_shift($result));

		$result = Hash::extract($r, 'Article[keep]');
		$this->assertEquals(array('keep' => array('Comment' => array())), array_shift($result));

		$r = $this->_containments($this->Tag, array('Article' => array('Users' => array('Comment' => array(
		...
		$this->assertTrue(Set::matches('/Users/keep/Comment', $r));
		$this->assertTrue(Set::matches('/Article/keep/Users', $r));
 ...
 */
	public function testBeforeFind() {
		...
		$this->assertFalse(Set::matches('/Users', $r));
		$this->assertTrue(Set::matches('/Comment', $r));
		$this->assertFalse(Set::matches('/Comment/Users', $r));

		$r = $this->Article->find('all', array('contain' => 'Comment.Users'));
		$this->assertTrue(Set::matches('/Comment/Users', $r));
		$this->assertFalse(Set::matches('/Comment/Article', $r));

		$r = $this->Article->find('all', array('contain' => array('Comment' => array('Users', 'Article'))));
		$this->assertTrue(Set::matches('/Comment/Users', $r));
		...
		$r = $this->Article->find('all', array('contain' => array('Users.Article(title)', 'Comment(comment)')));
		$this->assertFalse(Set::matches('/Comment/Article', $r));
		$this->assertFalse(Set::matches('/Comment/Users', $r));
		$this->assertTrue(Set::matches('/Comment/comment', $r));
		$this->assertFalse(Set::matches('/Comment/created', $r));
		$this->assertTrue(Set::matches('/Users/Article/title', $r));
		$this->assertFalse(Set::matches('/Users/Article/created', $r));
 ...
 */
	public function testContain() {
		$this->Article->contain('Comment.Users');
 ...
 */
	public function testContainFindList() {
		...
		$result = $this->Article->find('list', array('fields' => array('Article.id', 'Users.id'), 'contain' => array('Users')));
		$expected = array(
			1 => '1',
			2 => '3',
			3 => '1'
 ...
 */
	public function testFindFirstLevel() {
		...
		$this->Article->contain('Users', 'Comment');
		$result = $this->Article->find('all', array('recursive' => 1));
		$expected = array(
			array(
				'Article' => array(
 ...
 */
	public function testFindEmbeddedFirstLevel() {
		$result = $this->Article->find('all', array('contain' => array('Users')));
		$expected = array(
			array(
				'Article' => array(
					'id' => 1, 'user_id' => 1, 'title' => 'First Article', 'body' => 'First Article Body',
		...
		$result = $this->Article->find('all', array('contain' => array('Users', 'Comment')));
		$expected = array(
			array(
				'Article' => array(
					'id' => 1, 'user_id' => 1, 'title' => 'First Article', 'body' => 'First Article Body',
 ...
 */
	public function testFindSecondLevel() {
		$this->Article->contain(array('Comment' => 'Users'));
		...
		$this->Article->contain(array('Users' => 'ArticleFeatured'));
		$result = $this->Article->find('all', array('recursive' => 2));
		$expected = array(
			array(
				'Article' => array(
		...
		$this->Article->contain(array('Users' => array('ArticleFeatured', 'Comment')));
		$result = $this->Article->find('all', array('recursive' => 2));
		$expected = array(
			array(
				'Article' => array(
		...
		$this->Article->contain(array('Users' => array('ArticleFeatured')), 'Tag', array('Comment' => 'Attachment'));
		$result = $this->Article->find('all', array('recursive' => 2));
		$expected = array(
			array(
				'Article' => array(
 ...
 */
	public function testFindEmbeddedSecondLevel() {
		$result = $this->Article->find('all', array('contain' => array('Comment' => 'Users')));
		$expected = array(
			array(
				'Article' => array(
					'id' => 1, 'user_id' => 1, 'title' => 'First Article', 'body' => 'First Article Body',
		...
		$result = $this->Article->find('all', array('contain' => array('Users' => 'ArticleFeatured')));
		$expected = array(
			array(
				'Article' => array(
					'id' => 1, 'user_id' => 1, 'title' => 'First Article', 'body' => 'First Article Body',
		...
		$result = $this->Article->find('all', array('contain' => array('Users' => array('ArticleFeatured', 'Comment'))));
		$expected = array(
			array(
				'Article' => array(
					'id' => 1, 'user_id' => 1, 'title' => 'First Article', 'body' => 'First Article Body',
		...
		$result = $this->Article->find('all', array('contain' => array('Users' => 'ArticleFeatured', 'Tag', 'Comment' => 'Attachment')));
		$expected = array(
			array(
				'Article' => array(
					'id' => 1, 'user_id' => 1, 'title' => 'First Article', 'body' => 'First Article Body',
 ...
 */
	public function testSettingsThirdLevel() {
		...
		$this->assertTrue(Set::matches('/Users[id=1]', $r));
		$this->assertFalse(Set::matches('/Article', $r) || Set::matches('/Comment', $r));
		$this->assertTrue(Set::matches('/ArticleFeatured', $r));
		$this->assertFalse(Set::matches('/ArticleFeatured/Users', $r) || Set::matches('/ArticleFeatured/Comment', $r) || Set::matches('/ArticleFeatured/Tag', $r));
 ...
 */
	public function testFindEmbeddedThirdLevelNonReset() {
		...
		$this->_assertBindings($this->User->ArticleFeatured, array('belongsTo' => array('Users'), 'hasOne' => array('Featured'), 'hasMany' => array('Comment'), 'hasAndBelongsToMany' => array('Tag')));
		$this->_assertBindings($this->User->ArticleFeatured->Featured, array('belongsTo' => array('ArticleFeatured', 'Category')));
		$this->_assertBindings($this->User->ArticleFeatured->Comment, array('belongsTo' => array('Article', 'Users'), 'hasOne' => array('Attachment')));
		...
		$this->User->resetBindings();
		$this->_assertBindings($this->User, array('hasMany' => array('Article', 'ArticleFeatured', 'Comment')));
		$this->_assertBindings($this->User->Article, array('belongsTo' => array('Users'), 'hasMany' => array('Comment'), 'hasAndBelongsToMany' => array('Tag')));
		$this->_assertBindings($this->User->ArticleFeatured, array('belongsTo' => array('Users'), 'hasOne' => array('Featured'), 'hasMany' => array('Comment'), 'hasAndBelongsToMany' => array('Tag')));
		$this->_assertBindings($this->User->ArticleFeatured->Featured, array('belongsTo' => array('ArticleFeatured', 'Category')));
		$this->_assertBindings($this->User->ArticleFeatured->Comment, array('belongsTo' => array('Article', 'Users'), 'hasOne' => array('Attachment')));
	}
 ...
 */
	public function testEmbeddedFindFields() {
		$result = $this->Article->find('all', array(
			'contain' => array('Users(user)'),
			'fields' => array('title'),
			'order' => array('Article.id' => 'ASC')
		));
		$expected = array(
			array('Article' => array('title' => 'First Article'), 'Users' => array('user' => 'mariano', 'id' => 1)),
			array('Article' => array('title' => 'Second Article'), 'Users' => array('user' => 'larry', 'id' => 3)),
			array('Article' => array('title' => 'Third Article'), 'Users' => array('user' => 'mariano', 'id' => 1)),
		);
		$this->assertEquals($expected, $result);

		$result = $this->Article->find('all', array(
			'contain' => array('Users(id, user)'),
			'fields' => array('title'),
			'order' => array('Article.id' => 'ASC')
		));
		$expected = array(
		...
		$result = $this->Article->find('all', array(
			'contain' => array(
				'Comment(comment, published)' => 'Attachment(attachment)', 'Users(user)'
			),
			'fields' => array('title'),
			'order' => array('Article.id' => 'ASC')
		));
 ...
 */
	public function testHasOneFieldsInContain() {
		...
		$this->assertTrue(isset($result[0]['Users']['user']), 'body missing %s');
		$this->assertFalse(isset($result[0]['Comment']['published']), 'published found %s');
		$this->assertFalse(isset($result[0]['Users']['password']), 'password found %s');
	}
 ...
 */
	public function testFindConditionalBinding() {
		...
		$this->Article->contain(array('Users(id,user)', 'Tag' => array('fields' => array('tag', 'created'))));
		...
		$result = $this->Article->find('all', array(
			'fields' => array('title'),
			'contain' => array('Users(id,user)', 'Tag' => array('fields' => array('tag', 'created'))),
			'order' => array('Article.id' => 'ASC')
		));
		$expected = array(
			array(
		...
		$this->assertTrue(Set::matches('/Users[id=1]', $result));
 ...
 */
	public function testOtherFinds() {
		...
		$this->Article->contain(array('Users(id,user)', 'Tag' => array('fields' => array('tag', 'created'), 'conditions' => array('created >=' => '2007-03-18 12:24'))));
 ...
 */
	public function testOriginalAssociations() {
		...
		$this->Article->Comment->find('all', array(
			...
			'contain' => array('Users.password'),
		));

		$result = $this->Article->Comment->find('all', $options);
		$this->assertEquals($firstResult, $result);

		$this->Article->unbindModel(array('hasMany' => array('Comment'), 'belongsTo' => array('Users'), 'hasAndBelongsToMany' => array('Tag')), false);
		$this->Article->bindModel(array('hasMany' => array('Comment'), 'belongsTo' => array('Users')), false);

		$r = $this->Article->find('all', array('contain' => array('Comment(comment)', 'Users(user)'), 'fields' => array('title')));
		...
		$this->Article->contain(false, array('Users(id,user)', 'Comment' => array('fields' => array('comment'), 'conditions' => array('created >=' => '2007-03-18 10:49'))));
		...
		$result = $this->Article->find('all', array('fields' => array('title', 'Users.id', 'Users.user'), 'limit' => 1, 'page' => 2, 'order' => 'Article.id ASC'));
		$expected = array(array(
			'Article' => array('id' => 2, 'title' => 'Second Article'),
			'Users' => array('id' => 3, 'user' => 'larry'),
			'Comment' => array(
		...
		$result = $this->Article->find('all', array('fields' => array('title', 'Users.id', 'Users.user'), 'limit' => 1, 'page' => 3, 'order' => 'Article.id ASC'));
		$expected = array(array(
			'Article' => array('id' => 3, 'title' => 'Third Article'),
			'Users' => array('id' => 1, 'user' => 'mariano'),
			'Comment' => array()
		...
		$this->Article->contain(false, array('Users' => array('fields' => 'user'), 'Comment'));
		$result = $this->Article->find('all');
		$this->assertTrue(Set::matches('/Article[id=1]', $result));
		$this->assertTrue(Set::matches('/Users[user=mariano]', $result));
		$this->assertTrue(Set::matches('/Comment[article_id=1]', $result));
		$this->Article->resetBindings();

		$this->Article->contain(false, array('Users' => array('fields' => array('user')), 'Comment'));
		$result = $this->Article->find('all');
		$this->assertTrue(Set::matches('/Article[id=1]', $result));
		$this->assertTrue(Set::matches('/Users[user=mariano]', $result));
		$this->assertTrue(Set::matches('/Comment[article_id=1]', $result));
 ...
 */
	public function testResetDeeperHasOneAssociations() {
		...
		$this->Article->find('all', array(
			'contain' => array(
				'Users' => array('ArticleFeatured', 'Comment')
			)
		));
		$this->assertEquals($expected, $this->Article->User->hasOne);
 ...
 */
	public function testAutoFieldsWithMultipleDatabases() {
		...
		$this->fixtureManager->loadSingle('Users', $db);
		...
		$this->assertTrue(isset($result[0]['Users']));
	}
