 ...
 */
	public function testOldQuery() {
		$this->loadFixtures('Article', 'Users', 'Tag', 'ArticlesTag', 'Comment', 'Attachment');
		$Article = new Article();
 ...
 */
	public function testPreparedQuery() {
		$this->loadFixtures('Article', 'Users', 'Tag', 'ArticlesTag');
		$Article = new Article();
 ...
 */
	public function testFindNeighbors() {
		$this->loadFixtures('Users', 'Article', 'Comment', 'Tag', 'ArticlesTag', 'Attachment');
 ...
 */
	public function testBindUnbind() {
		...
		$expected = array(
			array('Users' => array('id' => '1', 'user' => 'mariano')),
			array('Users' => array('id' => '2', 'user' => 'nate')),
			array('Users' => array('id' => '3', 'user' => 'larry')),
			array('Users' => array('id' => '4', 'user' => 'garrett')));
		$this->assertEquals($expected, $result);
 ...
 */
	public function testBindMultipleTimes() {
		$this->loadFixtures('Users', 'Comment', 'Article', 'Tag', 'ArticlesTag');
		$TestModel = new User();
 ...
 */
	public function testBindModelMultipleTimesResetCorrectly() {
		$this->loadFixtures('Users', 'Comment', 'Article');
		$TestModel = new User();
 ...
 */
	public function testFindAll() {
		...
		$result = $TestModel->find('all', array('conditions' => 'Users.id > 2'));
		$expected = array(
			array(
				'Users' => array(
					'id' => '3',
		...
		$result = $TestModel->find('all', array(
			'conditions' => array('Users.id !=' => '0', 'Users.user LIKE' => '%arr%')
		));
		$expected = array(
			array(
				'Users' => array(
		...
		$result = $TestModel->find('all', array('conditions' => array('Users.id' => '0')));
		$expected = array();
		$this->assertEquals($expected, $result);

		$result = $TestModel->find('all', array(
			'conditions' => array('or' => array('Users.id' => '0', 'Users.user LIKE' => '%a%')
		)));
		...
		$result = $TestModel->find('all', array('fields' => 'Users.id, Users.user'));
		$expected = array(
				array('Users' => array('id' => '1', 'user' => 'mariano')),
				array('Users' => array('id' => '2', 'user' => 'nate')),
				array('Users' => array('id' => '3', 'user' => 'larry')),
		...
		$result = $TestModel->find('all', array('fields' => 'Users.user', 'order' => 'Users.user ASC'));
		$expected = array(
				array('Users' => array('user' => 'garrett')),
				array('Users' => array('user' => 'larry')),
				array('Users' => array('user' => 'mariano')),
				array('Users' => array('user' => 'nate')));
		$this->assertEquals($expected, $result);

		$result = $TestModel->find('all', array('fields' => 'Users.user', 'order' => 'Users.user DESC'));
		$expected = array(
				array('Users' => array('user' => 'nate')),
				array('Users' => array('user' => 'mariano')),
				array('Users' => array('user' => 'larry')),
 ...
 */
	public function testGenerateFindList() {
		$this->loadFixtures('Article', 'Apple', 'Post', 'Author', 'Users', 'Comment');
		...
		$TestModel = new User();
		$result = $TestModel->find('list', array(
			'fields' => array('Users.user', 'Users.password')
		));
		$expected = array(
		...
		$TestModel->displayField = 'title';
		$result = $TestModel->find('list', array(
			'conditions' => array('Users.user' => 'mariano'),
			'recursive' => 0
		));
		$expected = array(
			1 => 'First Article',
 ...
 */
	public function testFindField() {
		...
		$result = $TestModel->field('Users.user');
		$this->assertEquals('mariano', $result);
 ...
 */
	public function testFindCount() {
		$this->loadFixtures('Users', 'Article', 'Comment', 'Tag', 'ArticlesTag');
 ...
 */
	public function testRead() {
		$this->loadFixtures('Users', 'Article');
		$TestModel = new User();
		...
		$expected = array('Users' => array('id' => '2', 'user' => 'nate'));
		$this->assertEquals($expected, $result);
