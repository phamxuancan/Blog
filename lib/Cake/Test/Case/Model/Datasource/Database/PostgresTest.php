 ...
 */
	public function testVirtualFields() {
		$this->loadFixtures('Article', 'Comment', 'Users', 'Attachment', 'Tag', 'ArticlesTag');
		$Article = new Article;
		$Article->virtualFields = array(
			'next_id' => 'Article.id + 1',
			'complex' => 'Article.title || Article.body',
			'functional' => 'COALESCE(Users.user, Article.title)',
		...
		$this->assertEquals($result['Article']['functional'], $result['Users']['user']);
