 ...
 */
	public function testReadOnlyCallingQueryAssociationWhenDefined() {
		$this->loadFixtures('Article', 'Users', 'ArticlesTag', 'Tag');
 ...
 */
	public function testQueryAssociationUnneededQueries() {
		...
		// case: Comment belongsTo Users and Article
		...
		// case: Comment belongsTo Article, Article belongsTo Users
		$Comment->unbindModel(array(
			'belongsTo' => array('Users'),
			'hasOne' => array('Attachment')
		));
