 ...
 */
	public function testSaveDateAsFirstEntry() {
		$this->loadFixtures('Article', 'Users', 'Comment', 'Attachment', 'Tag', 'ArticlesTag');
 ...
 */
	public function testCounterCacheUpdated() {
		...
		$users = $User->find('all', array('order' => 'Users.id'));
		$this->assertEquals(1, $users[0]['Users']['post_count']);
		$this->assertEquals(2, $users[1]['Users']['post_count']);
	}
 ...
 */
	public function testCounterCacheWithNonstandardPrimaryKey() {
		...
		$users = $User->find('all', array('order' => 'Users.uid'));
		$this->assertEquals(1, $users[0]['Users']['post_count']);
		$this->assertEquals(2, $users[1]['Users']['post_count']);
	}
 ...
 */
	public function testCounterCacheMultipleCaches() {
		...
		$User = new CounterCacheUser();
		$Post = new CounterCachePost();
		$Post->unbindModel(array('belongsTo' => array('Users')), false);
		...
		$data[$Post->alias]['user_id'] = 301;
		$Post->save($data);
		$result = $User->find('all', array('order' => 'Users.id'));
		$this->assertEquals(2, $result[0]['Users']['post_count']);
		$this->assertEquals(1, $result[1]['Users']['posts_published']);
	}
 ...
 */
	public function testSaveWithNullId() {
		...
		$User->data['Users'] = array('password' => 'something');
		$result = $User->save();
		$this->assertFalse(empty($result));
		$result = $User->read();
		$this->assertEquals('something', $User->data['Users']['password']);
	}
 ...
 */
	public function testSaveHabtm() {
		$this->loadFixtures('Article', 'Users', 'Comment', 'Tag', 'ArticlesTag');
		$TestModel = new Article();
		...
		$TestModel->unbindModel(array('belongsTo' => array('Users'), 'hasMany' => array('Comment')));
 ...
 */
	public function testSaveHabtmNoPrimaryData() {
		...
		$TestModel->unbindModel(array('belongsTo' => array('Users'), 'hasMany' => array('Comment')), false);
		$result = $TestModel->findById(2);
		$expected = array(
			'Article' => array(
				'id' => '2',
 ...
 */
	public function testUpdateExisting() {
		$this->loadFixtures('Users', 'Article', 'Comment');
		$TestModel = new User();
		$TestModel->create();
		...
		$this->assertEquals('updated user', $result['Users']['user']);
		$this->assertEquals('some password', $result['Users']['password']);
 ...
 */
	public function testUpdateMultiple() {
		$this->loadFixtures('Comment', 'Article', 'Users', 'CategoryThread');
 ...
 */
	public function testSaveAll() {
		$this->loadFixtures('Post', 'Author', 'Comment', 'Attachment', 'Article', 'Users');
		$TestModel = new Post();
 ...
 */
	public function testSaveAllHabtm() {
		$this->loadFixtures('Article', 'Tag', 'Comment', 'Users', 'ArticlesTag');
		$data = array(
			'Article' => array(
				'user_id' => 1,
 ...
 */
	public function testSaveAllAtomic() {
		$this->loadFixtures('Article', 'Users', 'Comment');
		$TestModel = new Article();
 ...
 */
	public function testSaveAllDeepAssociated() {
		$this->loadFixtures('Article', 'Comment', 'Users', 'Attachment');
		$TestModel = new Article();
		...
		$result = $TestModel->saveAll(array(
			'Article' => array('id' => 2),
			'Comment' => array(
				array('comment' => 'First new comment', 'published' => 'Y', 'Users' => array('user' => 'newuser', 'password' => 'newuserpass')),
		...
		$expected = array('Users' => array('user' => array('This field cannot be left blank')));
		$this->assertEquals($expected, $TestModel->validationErrors);

		$data['Comment']['Article']['Users']['user'] = 'deepsave';
		$TestModel->Comment->Attachment->create();
		$result = $TestModel->Comment->Attachment->saveAll($data, array('deep' => true));
		$this->assertTrue($result);
		...
		unset(
			...
			$result['Users']['created'], $result['Users']['updated'],
	...
	public function testSaveAllDeepMany() {
		...
		$data = array(
			array(
				'Article' => array('id' => 1),
				'Comment' => array(
					array('comment' => 'First comment deepsaved article 1', 'published' => 'Y', 'Users' => array('user' => 'savemany', 'password' => 'manysaved')),
			...
			array(
				'Article' => array('id' => 2),
				'Comment' => array(
					array('comment' => 'First comment deepsaved article 2', 'published' => 'Y', 'Users' => array('user' => 'savemore', 'password' => 'moresaved')),
		...
		$data = array(
			array(
				'id' => 1, 'body' => '',
				'Comment' => array(
					array('comment' => '', 'published' => 'Y', 'Users' => array('user' => '', 'password' => 'manysaved')),
					array('comment' => 'Second comment deepsaved article 1', 'published' => 'Y', 'user_id' => 2)
				)
			),
			array(
				'Article' => array('id' => 2),
				'Comment' => array(
					array('comment' => 'First comment deepsaved article 2', 'published' => 'Y', 'Users' => array('user' => 'savemore', 'password' => '')),
	...
	public function testSaveAllDeepValidateOnly() {
		...
		$result = $TestModel->saveAll(
			array(
				'Article' => array('id' => 2),
				'Comment' => array(
					array('comment' => 'First new comment', 'published' => 'Y', 'Users' => array('user' => '', 'password' => 'newuserpass')),
					array('comment' => 'Second new comment', 'published' => 'Y', 'user_id' => 2)
				)
			),
			array('validate' => 'only', 'deep' => true)
		...
		$result = $TestModel->saveAll(array(
			...
			'Comment' => array(
				array(
					...
					'Users' => array('user' => 'newuser', 'password' => 'newuserpass')
				),
				array('comment' => 'Second new comment', 'published' => 'Y', 'user_id' => 2)
			)
		), array('deep' => false));
 ...
 */
	public function testSaveAllValidateFirst() {
		$this->loadFixtures('Article', 'Comment', 'Attachment', 'Users', 'ArticlesTag', 'Tag');
		$model = new Article();
		$model->deleteAll(true);
 ...
 */
	public function testSaveAssociatedAtomicFalseValidateFirstWithErrors() {
		$this->loadFixtures('Comment', 'Article', 'Users');
 ...
 */
	public function testSaveAssociatedAtomic() {
		$this->loadFixtures('Article', 'Users');
		$TestModel = new Article();
 ...
 */
	...
	public function testToggleBoolFields() {
		$this->loadFixtures('CounterCacheUser', 'CounterCachePost');
		$Post = new CounterCachePost();
		$Post->unbindModel(array('belongsTo' => array('Users')), true);
 ...
 */
	public function testSaveAllFieldListHasOne() {
		$this->loadFixtures('Attachment', 'Comment', 'Article', 'Users');
		$TestModel = new Comment();
 ...
 */
	public function testSaveAllDeepFieldListHasMany() {
		$this->loadFixtures('Article', 'Comment', 'Users');
		$TestModel = new Article();
		$TestModel->belongsTo = $TestModel->hasAndBelongsToMany = array();
		...
		$result = $TestModel->saveAll(array(
			...
			'Comment' => array(
				...
				array(
					...
					'Users' => array('user' => 'nopassword', 'password' => 'not saved')
				)
			)
		), array('fieldList' => $fieldList, 'deep' => true));

		$result = $TestModel->Comment->User->find('first', array(
			'conditions' => array('Users.user' => 'nopassword'),
		...
		$result = $TestModel->saveAll(array(
			...
			'Comment' => array(
				...
				array(
					...
					'Users' => array('user' => 'findme', 'password' => 'somepass')
				)
			)
		), array('deep' => true));

		$result = $TestModel->Comment->User->find('first', array(
			'conditions' => array('Users.user' => 'findme'),
