 ...
 * (i.e. class 'Users' => table 'users'; class 'Man' => table 'men')
 ...
 *   If you're defining a 'Profile belongsTo Users' relationship, the className key should equal 'Users.'
 ...
 *   practice to use model names in SQL fragments: 'Users.active = 1' is always
 ...
 *
 * - `className`: the classname of the model being associated to the current model.
 *   If you're defining a 'Users hasOne Profile' relationship, the className key should equal 'Profile.'
 ...
 *   Users will also delete her associated Profile.
 *
 * @var array
 ...
 *
 * - `className`: the classname of the model being associated to the current model.
 *   If you're defining a 'Users hasMany Comment' relationship, the className key should equal 'Comment.'
 * - `foreignKey`: the name of the foreign key found in the other model. This is
 ...
 *   associated Users record has been deleted.
 ...
 *
 * `$this->Users->bindModel( array('hasOne' => array('Profile')) );`
 *
 ...
 * to temporarily lighten the Users model:
 *
 * `$this->Users->unbindModel( array('hasMany' => array('Supportrequest')) );`
 *
