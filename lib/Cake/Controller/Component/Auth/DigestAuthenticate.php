 ...
 * login methods. For example `Users.digest_pass` could be used for a digest password, while `Users.password` would
 ...
 * - `userModel` The model name of the Users, defaults to Users.
 * - `scope` Additional conditions to use when looking up and authenticating users,
 *    i.e. `array('Users.is_active' => 1).`
...
/**
 * Authenticate a user using Digest HTTP auth. Will use the configured Users model and attempt a
