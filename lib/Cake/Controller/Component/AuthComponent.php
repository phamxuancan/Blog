 ...
 * unspecified, it will be "Auth.Users".
 *
 * @var string
 */
	public static $sessionKey = 'Auth.Users';
 ...
 *
 * @param string $key field to retrieve. Leave null to get entire Users record
 * @return mixed Users record. or null if no user is logged in.
 ...
 * @return array Users record data, or false, if the user could not be identified.
 */
