 ...
 *
 * array('Users' => array('username' => 'jeff', 'role' => 'editor'))
 *
 * is passed as an ARO to one of the methods of AclComponent, PhpAcl
 * will check if it can be resolved to an Users or a Role defined in the
 * configuration file.
 *
 * @var array
 ...
 *
 * @param string|array $aro ARO identifier (Users.jeff, array('Users' => ...), etc)
