 ...
 *
 * Given a set of Users array data, from a `$Users->find('all')` call:
 *
 * - `1.Users.name` Get the name of the user at index 1.
 * - `{n}.Users.name` Get the name of every user in the set of users.
 * - `{n}.Users[id]` Get the name of every user with an id key.
 * - `{n}.Users[id>=2]` Get the name of every user with an id key greater than or equal to 2.
 * - `{n}.Users[username=/^paul/]` Get Users elements with username matching `^paul`.
 *
 ...
 *
 * {{{
 * $result = Hash::format($users, array('{n}.Users.id', '{n}.Users.name'), '%s : %s');
 * }}}
 *
